...
<html>
    ...
    <body>
        ...
        <!-- Chatbot -->
        <script src="https://www.gstatic.com/dialogflow-console/fast/messenger/bootstrap.js?v=1" integrity="sha384-xp2qyPI/iX3Si91JehjydehUF4KlBvJmISBamSKb5IRrUkZfK3EA4xB1SBbtp4S6" crossorigin="anonymous"></script>        <df-messenger intent="WELCOME" chat-title="Chat_bot_web_shoes" agent-id="1f30195b-1044-492f-ac46-1df0d371d85e" language-code="en"></df-messenger>
    </body>
</html>
